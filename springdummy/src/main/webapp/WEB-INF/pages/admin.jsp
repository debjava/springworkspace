...
<table>
	<%-- <tr>
		<td><form:label path="student.name">Name---<form:input path="student.name" readonly="true"/> </form:label></td>
	</tr> --%>
	<tr>
	...
	<tr>
		...
		<%-- <td><input type="text" name="marks" value="${student.marks}" id="marksId"></td> --%>
	</tr>
</table>
